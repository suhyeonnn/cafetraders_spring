...
<meta charset="UTF-8">
<title>CEO약관동의</title>
<link rel="stylesheet" type="text/css" href=" ${pageContext.request.contextPath}/resources/css/join/CEOjoin.css">
...
<div id="ser7"><input type="button" value="가입하기" id="ser7_1" onclick="location.href='join2.ct';"></div> <br><br>
