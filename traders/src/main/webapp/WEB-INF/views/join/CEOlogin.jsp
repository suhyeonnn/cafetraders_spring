...
<link rel="stylesheet" type="text/css" href=" ${pageContext.request.contextPath}/resources/css/join/CEOlogin.css">
</head>
...
<input type="checkbox" id="ch_box1" name="ch"/><label for="ch_box1">아이디 저장</label><BR><br><!-- 쿠키? -->
